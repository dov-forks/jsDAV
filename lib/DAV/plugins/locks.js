...
var jsDAV_Locks_Plugin = module.exports = jsDAV_ServerPlugin.extend({
    ...
    httpLock: function(e) {
      ...
      // Always send 200 successful with fake lock token
      self.handler.httpResponse.writeHead(200, {
        "Content-Type": "application/xml; charset=utf-8",
        "Lock-Token": "<opaquelocktoken:0123456789>"
      });
      self.handler.httpResponse.end(self.generateEmptyLockResponse());
      e.stop();
      return;
    ...
    httpUnlock: function(e) {
        ...
        // Always send 204 response for successful UNLOCK
     ...
     * @return string
     */
    generateEmptyLockResponse: function(lockInfo) {
        ...
        return xml + "><d:lockdiscovery></d:lockdiscovery></d:prop>";
    },
  /**
   * Generates the response for successfull LOCK requests
   *
